...
<body style="background-color:rgb(188, 226, 241);">
            ...
            <h1 style="text-align:center;font-family:initial">Information Of All Pending Orders</h1>
            ...
            <!-- <th style="border:1px solid black;padding:10px;text-align:center;background-color:orangered;color:white;">Date Time</th> -->
            ...
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:orangered;color:white;">Upload Work</th>
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:orangered;color:white;">Send Email</th>
            </tr>
            <?php
             $Query="SELECT * From orderpending";
             ...
             else
             {
                ...
                <tr>
                    ...
                    <!-- <td style="border:1px solid black;background-color:white;padding:10px;text-align:center;"><?php echo $data['dateTime'] ?></td> -->
                    ...
                    <td style="border:1px solid black;background-color:white;padding:10px;text-align:center;"><a href="upload.php?id=<?php echo $Data['id']?>&oid=<?php echo $data['id']?>">Upload</a></td>
                    <td style="border:1px solid black;background-color:white;padding:10px;text-align:center;"><a href="mail.php?id=<?php echo $Data['id']?>">Email</a></td>
                  </tr>
