	...
	<section class="container-fluid" style="font-size:18px;margin-top:50px">
		...
		<section class="row justify-content-center" >
		  <section class="col-12 col-sm-6 col-md-4">
			<form class="form-container" action="uploadPHP.php" method="post" enctype="multipart/form-data">
			<div class="form-group">
			  <h1 class="text-center font-weight-bold" style="font-family:initial;">upload File</h1>
			  <label for="InputName1">Name</label>
			   <input type="text" style="height:40px;font-size:14px" class="form-control" id="InputComName" aria-describeby="nameHelp" placeholder="Enter File name" name="Name"required>
            </div>
			<label>File</label>
        ...
        <div class="form-group">
            ...
            <input type="text"  style="display:none" class="form-control" id="InputPassword1" placeholder="id  is selected" name="id" value="<?php echo $Id ?>"required >
          </div>
		</div>
		<div class="form-group">
			
            <input type="text"  style="display:none" class="form-control" id="InputPassword1" placeholder="id  is selected" name="oid" value="<?php echo $oid ?>"required >
          </div>
        </div>
          <br>
			<button type="submit" class="btn btn-primary btn-block" name="submit" style="height:40px;font-size:18px">upload</button>
